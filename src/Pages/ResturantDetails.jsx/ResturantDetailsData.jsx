...
export default function ResturantDetailsData() {
  return (
    <section className="relative">
      <Navbar bgColor="bg-transparent"/>

      <div className="relative flex items-end bg-resturantDetailBg bg-no-repeat bg-cover bg-center h-[500px]  pt-40 before:absolute before:bg-paraColor before:w-full before:h-[500px] before:top-0 before:left-0">
